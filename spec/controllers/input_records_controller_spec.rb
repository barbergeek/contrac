...
describe InputRecordsController do
  ...
  describe "GET new" do
    it "assigns a new input_record as @input_record" do
      InputRecord.stub(:new) { mock_input_record }
      get :new
      assigns(:input_record).should be(mock_input_record)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created input_record as @input_record" do
        InputRecord.stub(:new).with({'these' => 'params'}) { mock_input_record(:save => true) }
        post :create, :input_record => {'these' => 'params'}
        assigns(:input_record).should be(mock_input_record)
      end

      it "redirects to the created input_record" do
        InputRecord.stub(:new) { mock_input_record(:save => true) }
        post :create, :input_record => {}
        response.should redirect_to(input_record_url(mock_input_record))
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved input_record as @input_record" do
        InputRecord.stub(:new).with({'these' => 'params'}) { mock_input_record(:save => false) }
        post :create, :input_record => {'these' => 'params'}
        assigns(:input_record).should be(mock_input_record)
      end

      it "re-renders the 'new' template" do
        InputRecord.stub(:new) { mock_input_record(:save => false) }
        post :create, :input_record => {}
